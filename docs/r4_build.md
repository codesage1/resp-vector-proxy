...
**Problem:** The real WASP architecture intercepts `FT.SEARCH` queries and routes them to Oracle, but the client writes data (`HSET`) to Kvrocks. How does Oracle acquire the data to answer the search?
